...
Note that the script also looks for records missing from the beginning. With Chromimum only keeping the last 90 days of history, you are virtually guaranteed to see a gap at the beginning.
